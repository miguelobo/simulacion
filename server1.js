 ...
 */
/**
 * Created by JOSE MANUEL LOBO on 24/04/17.
 */
...
app.get('/', function(req, res) {
    ...
    //res.end('Servidor de websockets escuchando en puerto: ' + puerto);
    res.end('Servidor de websockets para Adith perez Materia Modelo y Simulacion.');
});
